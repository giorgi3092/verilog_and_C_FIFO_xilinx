...
HD_PWD='C:/Users/aptsi/Desktop/FIFO_MiniZed/FIFO_MiniZed.runs/PL_BRAM_BD_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PL_BRAM_BD_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PL_BRAM_BD_processing_system7_0_0.tcl
