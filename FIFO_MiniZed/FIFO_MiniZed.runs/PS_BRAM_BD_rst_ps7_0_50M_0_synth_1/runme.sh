...
HD_PWD='C:/Users/aptsi/Desktop/FIFO_MiniZed/FIFO_MiniZed.runs/PS_BRAM_BD_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PS_BRAM_BD_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PS_BRAM_BD_rst_ps7_0_50M_0.tcl
