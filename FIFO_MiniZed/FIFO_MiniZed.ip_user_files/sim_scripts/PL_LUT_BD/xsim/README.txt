...
#
# Generated by export_simulation on Thu Jul 25 13:57:26 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './PL_LUT_BD.sh' script.

./PL_LUT_BD.sh -reset_run
...
./PL_LUT_BD.sh -noclean_files

For more information on the script, please type './PL_LUT_BD.sh -help'.
