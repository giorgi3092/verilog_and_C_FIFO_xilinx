...
//Date        : Tue Jul 30 14:13:22 2019
//Host        : ENG-E218PC04 running 64-bit major release  (build 9200)
//Command     : generate_target PS_DRAM_BD.bd
//Design      : PS_DRAM_BD
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "PS_DRAM_BD,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PS_DRAM_BD,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "PS_DRAM_BD.hwdef" *) 
module PS_DRAM_BD
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  PS_DRAM_BD_processing_system7_0_0 processing_system7_0
